...
ggplot2::ggplot(power_df, 
                ...
                ggplot2::geom_count(colour="yellow") +
                ggplot2::theme_dark()
...
On peut vérifier que, dans le "taille", la taille de "50" est meuilleure que celle de 5. Dans la "moyenne", la moyenne de "2" est meilleurs que celle de "1". Et, Dans la "écart type"", l'écart type de "2" est meilleurs que celui de "6".